...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
        ...
        vehicleTypes: json["vehicle_types"] == null ? [] : List<VehicleTypeElement>.from(json["vehicle_types"]!.map((x) => VehicleTypeElement.fromJson(x))),
        ...
        partsDescription: json["parts_description"] == null ? [] : List<MobileMechanicCategory>.from(json["parts_description"]!.map((x) => MobileMechanicCategory.fromJson(x))),
        ...
        vehicleTypesForDrivers: json["vehicle_types_for_drivers"] == null ? [] : List<VehicleTypeElement>.from(json["vehicle_types_for_drivers"]!.map((x) => VehicleTypeElement.fromJson(x))),
        ...
        mechanicRepairTypes: json["mechanic_repair_types"] == null ? [] : List<MechanicRepairType>.from(json["mechanic_repair_types"]!.map((x) => MechanicRepairType.fromJson(x))),
        mechanicSpecialisms: json["mechanic_specialisms"] == null ? [] : List<AllFeature>.from(json["mechanic_specialisms"]!.map((x) => AllFeature.fromJson(x))),
        mobileMechanicCategories: json["mobile_mechanic_categories"] == null ? [] : List<MobileMechanicCategory>.from(json["mobile_mechanic_categories"]!.map((x) => MobileMechanicCategory.fromJson(x))),
        mobileMechanicAvailability: json["mobile_mechanic_availability"] == null ? null : MobileMechanicAvailability.fromJson(json["mobile_mechanic_availability"]),
        insuranceProviders: json["insurance_providers"] == null ? [] : List<Map<String, String?>>.from(json["insurance_providers"]!.map((x) => Map.from(x).map((k, v) => MapEntry<String, String?>(k, v)))),
        destinationPort: json["destination_port"] == null ? [] : List<DestinationPort>.from(json["destination_port"]!.map((x) => DestinationPort.fromJson(x))),
  ...
  Map<String, dynamic> toJson() => {
        ...
        "vehicle_types": vehicleTypes == null
            ? []
            : List<dynamic>.from(vehicleTypes!.map((x) => x.toJson())),
        "vehicle_conditions": vehicleConditions?.toJson(),
        "packages": packages?.toJson(),
        "fuels": fuels == null
            ? []
            : List<dynamic>.from(fuels!.map((x) => x.toJson())),
        "currency": currency?.toJson(),
        "gearbox": gearbox?.toJson(),
        "manufacturing_years": manufacturingYears == null
            ? []
            : List<dynamic>.from(manufacturingYears!.map((x) => x)),
        "body_type": bodyType == null
            ? []
            : List<dynamic>.from(bodyType!.map((x) => x.toJson())),
        "colors": colors == null
            ? []
            : List<dynamic>.from(colors!.map((x) => x.toJson())),
        "seats":
            Map.from(seats!).map((k, v) => MapEntry<String, dynamic>(k, v)),
        "owner_type":
            Map.from(ownerType!).map((k, v) => MapEntry<String, dynamic>(k, v)),
        "all_features": allFeatures == null
            ? []
            : List<dynamic>.from(allFeatures!.map((x) => x.toJson())),
        "parts": parts == null
            ? []
            : List<dynamic>.from(parts!.map((x) => x.toJson())),
        "parts_for": partsFor == null
            ? []
            : List<dynamic>.from(partsFor!.map((x) => x.toJson())),
        "parts_description": partsDescription == null
            ? []
            : List<dynamic>.from(partsDescription!.map((x) => x.toJson())),
        "ages": ages == null ? [] : List<dynamic>.from(ages!.map((x) => x)),
        "engine_sizes": engineSizes == null
            ? []
            : List<dynamic>.from(engineSizes!.map((x) => x.toJson())),
        "body_types": bodyTypes == null
            ? []
            : List<dynamic>.from(bodyTypes!.map((x) => x.toJson())),
        "wheels":
            Map.from(wheels!).map((k, v) => MapEntry<String, dynamic>(k, v)),
        "service_history": Map.from(serviceHistory!)
            .map((k, v) => MapEntry<String, dynamic>(k, v)),
        "education_type": Map.from(educationType!)
            .map((k, v) => MapEntry<String, dynamic>(k, v)),
        "vehicle_types_for_drivers": vehicleTypesForDrivers == null
            ? []
            : List<dynamic>.from(
                vehicleTypesForDrivers!.map((x) => x.toJson())),
        "license_type": Map.from(licenseType!)
            .map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
        "driver_location": driverLocation == null
            ? []
            : List<dynamic>.from(driverLocation!.map((x) => x.toJson())),
        "driver_marital_status": Map.from(driverMaritalStatus!)
            .map((k, v) => MapEntry<String, dynamic>(k, v)),
        "driver_status": driverStatus == null
            ? []
            : List<dynamic>.from(driverStatus!.map((x) => x)),
        "driver_service_types": Map.from(driverServiceTypes!)
            .map((k, v) => MapEntry<String, dynamic>(k, v)),
        "driver_hire_periods": Map.from(driverHirePeriods!)
            .map((k, v) => MapEntry<String, dynamic>(k, v)),
        "mechanic_service_type": mechanicServiceType?.toJson(),
        "mechanic_repair_types": mechanicRepairTypes == null
            ? []
            : List<dynamic>.from(mechanicRepairTypes!.map((x) => x.toJson())),
        "mechanic_specialisms": mechanicSpecialisms == null
            ? []
            : List<dynamic>.from(mechanicSpecialisms!.map((x) => x.toJson())),
        "mobile_mechanic_categories": mobileMechanicCategories == null
            ? []
            : List<dynamic>.from(
                mobileMechanicCategories!.map((x) => x.toJson())),
        "mobile_mechanic_availability": mobileMechanicAvailability?.toJson(),
        "insurance_providers": insuranceProviders == null
            ? []
            : List<dynamic>.from(insuranceProviders!.map((x) =>
                Map.from(x).map((k, v) => MapEntry<String, dynamic>(k, v)))),
        "destination_port": destinationPort == null
            ? []
            : List<dynamic>.from(destinationPort!.map((x) => x.toJson())),
...
class MechanicRepairType {
  ...
  factory MechanicRepairType.fromJson(Map<String, dynamic> json) =>
      MechanicRepairType(
        id: json["id"],
        title: json["title"],
        image: json["image"],
...
class MechanicServiceType {
  ...
  factory MechanicServiceType.fromJson(Map<String, dynamic> json) =>
      MechanicServiceType(
...
class MobileMechanicAvailability {
  ...
  factory MobileMechanicAvailability.fromJson(Map<String, dynamic> json) =>
      MobileMechanicAvailability(
...
class MobileMechanicCategory {
  ...
  factory MobileMechanicCategory.fromJson(Map<String, dynamic> json) =>
      MobileMechanicCategory(
        id: json["id"],
        parentId: json["parent_id"],
        name: json["name"],
...
class VehicleConditions {
  ...
  factory VehicleConditions.fromJson(Map<String, dynamic> json) =>
      VehicleConditions(
