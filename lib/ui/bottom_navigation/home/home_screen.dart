      ...
      child: SizedBox(
        ...
        child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              ...
              return DynamicPostCarCard(
                image: bikeCarSpareParts.photo ?? '',
                title: bikeCarSpareParts.title ?? '',
                price: '₦ ${bikeCarSpareParts.priceinnaira}?? ||',
                location: bikeCarSpareParts.location,
              );
            }),
      ),
    );
